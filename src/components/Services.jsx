...
const services = [
    {
        id: 1,
        icon: <FaLaptopCode className="text-blue-800 w-12 h-12 mb-4" aria-hidden="true" />,
        title: 'Desarrollo Web',
        description: 'Creamos sitios web personalizados y responsivos que se adaptan a las necesidades de tu negocio.',
    },
    {
        id: 2,
        icon: <FaMobileAlt className="text-blue-800 w-12 h-12 mb-4" aria-hidden="true" />,
        title: 'Desarrollo Móvil',
        description: 'Desarrollamos aplicaciones móviles intuitivas y funcionales para iOS y Android.',
    },
    {
        id: 3,
        icon: <FaSearch className="text-blue-800 w-12 h-12 mb-4" aria-hidden="true" />,
    ...
    {
        id: 4,
        icon: <FaPaintBrush className="text-blue-800 w-12 h-12 mb-4" aria-hidden="true" />,
        title: 'Diseño UX/UI',
        description: 'Diseños atractivos y funcionales que mejoran la experiencia de tus usuarios.',
    },
    {
        id: 5,
        icon: <FaLock className="text-blue-800 w-12 h-12 mb-4" aria-hidden="true" />,
        title: 'Seguridad Web',
        description: 'Implementamos medidas de seguridad avanzadas para proteger tu sitio web y los datos de tus clientes.',
    },
    {
        id: 6,
        icon: <FaDatabase className="text-blue-800 w-12 h-12 mb-4" aria-hidden="true" />,
...
const Services = () => {
    return (
        <section id="services" className="bg-gradient-to-t from-blue-200 via-blue-300 to-blue-400 py-20">
            <div className="max-w-7xl mx-auto px-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                    {services.map((service) => (
                        <div key={service.id} className="bg-white bg-clip-padding backdrop-filter backdrop-blur bg-opacity-80 backdrop-saturate-100 backdrop-contrast-100 p-6 rounded-lg shadow-md hover:shadow-xl transition-shadow duration-300">
                            {/* Ícono */}
